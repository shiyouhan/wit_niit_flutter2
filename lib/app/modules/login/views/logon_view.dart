...
import '../controllers/logon_controller.dart';

class LogonView extends GetView<LogonController> {
  const LogonView({Key? key}) : super(key: key);
...
class _CodeState extends State<Code> {
  LogonController controller = Get.put(LogonController());
