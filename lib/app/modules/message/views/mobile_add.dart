...
/// 搜索AppBar
///MobileAdd
class MobileAdd extends StatefulWidget implements PreferredSizeWidget {
  MobileAdd({
    Key? key,
  ...
  @override
  _MobileAddState createState() => _MobileAddState();

  @override
  Size get preferredSize => Size.fromHeight(height);
}

class _MobileAddState extends State<MobileAdd> {
